...
export const fetchConfirmEmail = createAsyncThunk('auth/fetchConfirmEmail', async (params, {rejectWithValue}) => {
    try {
...
export const fetchResetPassword = createAsyncThunk('auth/fetchResetPassword', async (params, {rejectWithValue}) => {
    try {
...
export const fetchChangePassword = createAsyncThunk('auth/fetchChangePassword', async (info, {rejectWithValue}) => {
    try {
        const { token, values } = info;
        const { data } = await axios.post(`/api/auth/password-reset/${token}`, values);
        return data;
    }
    catch(error) {
        return rejectWithValue(error.response.data.error);
...
export const fetchCheckToken = createAsyncThunk('auth/fetchCheckToken', async (params, {rejectWithValue}) => {
    try {
...
export const fetchAuthMe = createAsyncThunk('auth/fetchAuthMe', async (userToken, {rejectWithValue}) => {
    try {
